...
public class EstudioMenu {
		...
		do {
			try {
				...
				case PERSISTENCIA_MARIADB:
					EstudioInputAdapterCli.setPersonOutputPortInjection("MARIA");
					menuOpciones(EstudioInputAdapterCli,keyboard);
					break;
				case PERSISTENCIA_MONGODB:
					EstudioInputAdapterCli.setPersonOutputPortInjection("MONGO");
					menuOpciones(EstudioInputAdapterCli,keyboard);
					break;
				default:
	...
	private void menuOpciones(EstudioInputAdapterCli EstudioInputAdapterCli, Scanner keyboard) {
		...
		do {
			try {
				...
				case OPCION_VER_UNA:
					keyboard.nextLine();
					System.out.print("Ingrese la id del estudio: ");					
					break;
	...
	private void mostrarMenuOpciones() {
		...
		System.out.println(OPCION_CREAR + " para crear un nueva estudio");
		System.out.println(OPCION_EDITAR + " para editar un estudios");
